document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayProfile(customer) {
        customerProfile.innerHTML = `
            ...
            <h3>Revenue</h3>
            <ul>
                <li><strong>2023:</strong> ${customer.profile.revenue['2023']}</li>
                <li><strong>2022:</strong> ${customer.profile.revenue['2022']}</li>
                <li><strong>2021:</strong> ${customer.profile.revenue['2021']}</li>
            </ul>
    ...
    function generateRecommendation(customer) {
        ...
        recommendation.innerHTML = `
            ...
            <p><strong>Recommendation:</strong> ${nextBestAction}</p>
            <p><strong>Conversation Starter:</strong> ${conversationStarter}</p>
        `;
    }
});
